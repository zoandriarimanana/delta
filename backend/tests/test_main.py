...
def test_routes_montees_sous_le_prefixe_d_api() -> None:
    ...
    assert set(app.openapi()["paths"]) == {
        ...
        f"{prefixe}/commandes",
        f"{prefixe}/commandes/administration",
        f"{prefixe}/commandes/administration/{{id_commande}}",
        f"{prefixe}/commandes/administration/{{id_commande}}/statut",
        f"{prefixe}/commandes/administration/{{id_commande}}/remboursement",
        ...
        f"{prefixe}/commandes/{{id_commande}}/paiements",
        f"{prefixe}/domaines-formation",
        f"{prefixe}/domaines-formation/administration",
        f"{prefixe}/domaines-formation/{{id_domaine}}",
        f"{prefixe}/domaines-formation/{{id_domaine}}/restauration",
        f"{prefixe}/formations",
        f"{prefixe}/formations/administration",
        f"{prefixe}/formations/{{id_formation}}",
        f"{prefixe}/formations/{{id_formation}}/restauration",
        f"{prefixe}/sessions-formation",
        f"{prefixe}/sessions-formation/administration",
        ...
        f"{prefixe}/logements",
        f"{prefixe}/logements/administration",
        f"{prefixe}/logements/{{id_logement}}",
        f"{prefixe}/logements/{{id_logement}}/restauration",
        f"{prefixe}/salles",
        f"{prefixe}/salles/administration",
        f"{prefixe}/salles/{{id_salle}}",
        f"{prefixe}/salles/{{id_salle}}/restauration",
        f"{prefixe}/reservations",
        f"{prefixe}/reservations/administration",
        f"{prefixe}/reservations/administration/{{id_reservation}}",
        f"{prefixe}/reservations/administration/{{id_reservation}}/statut",
        ...
        f"{prefixe}/personnel/{{id_personnel}}/badge",
